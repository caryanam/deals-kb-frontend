...
const buyerPasses = [
  { category: 'Mobile', icon: '📱', price: '₹21', duration: '24 hours', desc: 'Place unlimited bids on mobile auctions' },
  { category: 'Laptop', icon: '💻', price: '₹51', duration: '24 hours', desc: 'Place unlimited bids on laptop auctions' },
  { category: 'Bike', icon: '🏍️', price: '₹111', duration: '24 hours', desc: 'Place unlimited bids on bike auctions' },
  { category: 'Car', icon: '🚗', price: '₹499', duration: '24 hours', desc: 'Place unlimited bids on car auctions' },
];

const sellerFees = [
  { category: 'Mobile Listing', icon: '📱', price: '₹21', type: 'one-time' },
  { category: 'Laptop Listing', icon: '💻', price: '₹51', type: 'one-time' },
  { category: 'Bike Listing', icon: '🏍️', price: '₹99', type: 'one-time' },
  { category: 'Car Listing', icon: '🚗', price: '₹399', type: 'one-time' },
];
      ...
      <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
        ...
        >
          ...
          >
            ...
            >
              Unlimited listings across all categories — Cars, Bikes, Mobiles, and Laptops.
              No per-listing charges. Perfect for professional dealers.
            </p>
            <ul
              style={{
                listStyle: 'none',
