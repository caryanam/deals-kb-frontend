  ...
  return (
    <div style={{ fontFamily: "'Plus Jakarta Sans', sans-serif" }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
        <div>
          <h1 style={{ fontSize: '2rem', fontWeight: 800, color: '#0b0f19', fontFamily: "'Outfit', sans-serif" }}>Platform Analytics</h1>
          <p style={{ color: '#64748b', fontSize: '0.9rem' }}>Site activity metrics, listing distributions, and auction volumes</p>
        </div>
        <button 
      ...
      {loading ? (
        <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', height: '200px', flexDirection: 'column', gap: '1rem' }}>
          ...
          <span style={{ color: '#64748b', fontSize: '0.85rem' }}>Loading analytics metrics...</span>
        </div>
      ) : (
        /* Analytics Grid */
        <div style={{ display: 'flex', flexDirection: 'column', gap: '2rem' }}>
          ...
          <div className="grid grid-cols-3">
            <div className="card">
              <span style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 700, textTransform: 'uppercase' }}>Gross Merchandise Volume (GMV)</span>
              ...
              <p style={{ fontSize: '0.8rem', color: '#94a3b8', margin: 0 }}>Aggregate concluded auction sales values</p>
            </div>
            
            <div className="card">
              <span style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 700, textTransform: 'uppercase' }}>Bidding Activity Volume</span>
              <h3 style={{ fontSize: '2rem', fontWeight: 800, color: '#2563eb', display: 'flex', alignItems: 'center', gap: '0.5rem', margin: '0.25rem 0' }}>
                <Landmark size={24} /> {data?.total_bids || 0}
              </h3>
              <p style={{ fontSize: '0.8rem', color: '#94a3b8', margin: 0 }}>Total individual bids submitted</p>
            </div>

            <div className="card">
              <span style={{ fontSize: '0.8rem', color: '#64748b', fontWeight: 700, textTransform: 'uppercase' }}>Concluded Auctions</span>
              ...
              <p style={{ fontSize: '0.8rem', color: '#94a3b8', margin: 0 }}>Total listings sold upon expiration</p>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '2rem' }} className="grid-cols-2">
            ...
            <div className="card">
              <h3 style={{ fontSize: '1.15rem', fontWeight: 700, marginBottom: '1.5rem', display: 'flex', alignItems: 'center', gap: '0.5rem', borderBottom: '1px solid #e2e8f0', paddingBottom: '0.75rem' }}>
                <BarChart3 size={18} style={{ color: '#2563eb' }} /> Products Distribution by Category
              </h3>
                    ...
                    return (
                      <div key={key} style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', fontWeight: 700 }}>
                          ...
                          <span style={{ color: '#0f172a' }}>{val} ({percentage}%)</span>
                        </div>
                        <div style={{
                          height: '10px',
            ...
            <div className="card">
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem' }}>
                {[
                  ...
                  { name: 'Approved', count: data?.approved_listings || 0, color: '#2563eb' },
                  ...
                  return (
                    <div key={idx} style={{ display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
                      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '0.85rem', fontWeight: 700 }}>
                        <span style={{ color: '#475569' }}>{status.name}</span>
                        <span style={{ color: '#0f172a' }}>{status.count} ({pct}%)</span>
                      </div>
                      <div style={{
                        height: '10px',
                        backgroundColor: '#e2e8f0',
